        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-10">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-200 rounded-xl text-gray-700 font-medium text-sm hover:border-gray-800 hover:bg-gray-50 hover:shadow-md active:scale-[0.98] transition-all duration-200"
            >
